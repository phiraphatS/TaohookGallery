...
<body>
    ...
    <div class="homecontent">
        ...
        <h1>ตัวอย่างผลงาน</h1>
        <h3 style="margin-top : 10px;">คุณอยากถ่ายรูปแบบไหน เราจัดให้ ลองติดต่อเราสิ <a href="book.php">Click!</a></h3>
        ...
        $sql = "SELECT * FROM work_sample";
        $db_query = mysqli_query($conn, $sql);
        $path = "pic/";
        while($result = mysqli_fetch_array($db_query)){
        $image = $result['album_pic'];
        $name = $result['album_type'];
        $album_id = $result['album_id'];
        ?>
        <figure class="snip">
            <img src="<?php echo $path.$image; ?>" height="220px" alt="" />
            <figcaption>
                <h3>ถ่ายรูป <span><?php echo $name; ?></span></h3>
            </figcaption>
            <a href="explan.php?al_id=<?=$album_id?>"></a>
        </figure>
